...
final List<Descartavel> descartaveis = [
  ...
  Descartavel(name: 'COPO ISOPOR 180ML (EMBALAGAS FECHADAS)', type: 'quantity'),
  Descartavel(name: 'COPO ISOPOR 120ML (EMBALAGAS FECHADAS)', type: 'quantity'),
  Descartavel(name: 'COPO ORAMA 180ML (EMBALAGAS FECHADAS)', type: 'quantity'),
  Descartavel(name: 'GIZ LIQUIDO', type: 'numeric'),
  Descartavel(name: 'ISOPOR VIAGENS', type: 'numeric'),
  Descartavel(name: 'GUARDANAPO (EMBALAGAS FECHADAS)', type: 'quantity'),
