...
mixin _$ComandaStore on _ComandaStoreBase, Store {
  ...
  late final _$expansionStateAtom =
      Atom(name: '_ComandaStoreBase.expansionState', context: context);

  @override
  ObservableMap<String, bool> get expansionState {
    _$expansionStateAtom.reportRead();
    return super.expansionState;
  }

  @override
  set expansionState(ObservableMap<String, bool> value) {
    _$expansionStateAtom.reportWrite(value, super.expansionState, () {
      super.expansionState = value;
    });
  }

  late final _$syncWithFirebaseChangesAsyncAction = AsyncAction(
      '_ComandaStoreBase.syncWithFirebaseChanges',
      context: context);

  @override
  Future<void> syncWithFirebaseChanges() {
    return _$syncWithFirebaseChangesAsyncAction
        .run(() => super.syncWithFirebaseChanges());
  }
  ...
  void setExpansionState(String comandaId, bool isExpanded) {
    final _$actionInfo = _$_ComandaStoreBaseActionController.startAction(
        name: '_ComandaStoreBase.setExpansionState');
    try {
      return super.setExpansionState(comandaId, isExpanded);
    } finally {
  ...
  bool getExpansionState(String comandaId) {
    final _$actionInfo = _$_ComandaStoreBaseActionController.startAction(
        name: '_ComandaStoreBase.getExpansionState');
    try {
      return super.getExpansionState(comandaId);
    } finally {
      _$_ComandaStoreBaseActionController.endAction(_$actionInfo);
    }
  }
