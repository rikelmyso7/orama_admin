...
class _StockItemCardState extends State<StockItemCard> {
  ...
  void initState() {
    ...
    kgController =
        TextEditingController(text: store.kgValues[widget.itemName] ?? '0.000');
    ...
    kgController.addListener(() {
      store.updateKg(widget.itemName, kgController.text);
      setState(() {
        isKgFilled = kgController.text.isNotEmpty;
      });
    });
